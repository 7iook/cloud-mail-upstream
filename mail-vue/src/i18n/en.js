const en = {
    ...
    shareConfigRejected: 'This setting was not accepted: it may be outside the currently allowed range, or the capability is not open yet. Adjust it and try again.',
    ...
    shareAuthKeyFailed: 'Could not finish: the capability may not be open yet, or the share status just changed. Refresh and try again.',
    shareDetail: 'Details',
